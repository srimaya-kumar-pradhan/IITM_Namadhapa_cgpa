...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)"); // Re-triggering IDE re-index
...
function Calculator() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Calculator.useEffect": ()=>{
            ...
            if (saved) {
                ...
                const defaults = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$grading$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_COURSES"][domain].map({
                    "Calculator.useEffect.defaults": (c)=>({
                            ...c,
                            id: Math.random().toString(36).substr(2, 9),
                            grade: 'S',
                            isOngoing: false
                        })
                }["Calculator.useEffect.defaults"]);
                setCourses(defaults);
            }
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Calculator.useMemo[stats]": ()=>{
            const current = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$grading$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["calculateCGPA"])(courses.filter({
                "Calculator.useMemo[stats].current": (c)=>!c.isOngoing
            }["Calculator.useMemo[stats].current"]));
            const predicted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$grading$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["predictCGPA"])(courses.filter({
                "Calculator.useMemo[stats].predicted": (c)=>!c.isOngoing
            }["Calculator.useMemo[stats].predicted"]), courses.filter({
                "Calculator.useMemo[stats].predicted": (c)=>c.isOngoing
            }["Calculator.useMemo[stats].predicted"]));
            return {
                current,
                predicted
            };
    ...
    const addCourse = (type)=>{
        if (!newCourse.name) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('Please enter a course name');
            return;
        }
        const course = {
            id: Math.random().toString(36).substr(2, 9),
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`${type === 'completed' ? 'Completed' : 'Ongoing'} course added`);
    };
    const removeCourse = (id)=>{
        setCourses(courses.filter((c)=>c.id !== id));
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].info('Course removed');
    };
    ...
    const resetData = ()=>{
        if (confirm('Are you sure you want to reset all data?')) {
            const defaults = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$grading$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_COURSES"][domain].map((c)=>({
                    ...c,
                    id: Math.random().toString(36).substr(2, 9),
                    grade: 'S',
                    isOngoing: false
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Data reset to defaults');
        }
    };
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                ...
                                onValueChange: (v)=>{
                                    ...
                                    if (confirm(`Switching to ${v} will reset your current course list. Continue?`)) {
                                        const defaults = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$grading$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DEFAULT_COURSES"][v].map((c)=>({
                                                ...c,
                                                id: Math.random().toString(36).substr(2, 9),
                                                grade: 'S',
                                                isOngoing: false
                                    ...
                                    children: [
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Select"], {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectContent"], {
                                                                    children: Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$grading$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GRADE_POINTS"]).map((g)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$select$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SelectItem"], {
                                                                            value: g,
                                                                            children: g
                                                                        }, g, false, {
                                                                            fileName: "[project]/src/components/calculator/Calculator.tsx",
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                courses.filter((c)=>!c.isOngoing).length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Calculator, "53DU/4dpCO3Hgu3czbuc6izEaqk=");
_c = Calculator;
var _c;
...
//# sourceMappingURL=src_db57c2ee._.js.map